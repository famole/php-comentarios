...
echo "<tr bgcolor='#f1f1f1'><td><b>id</b>:&nbsp;&nbsp;$nt[post_id] <br><b>Nombre</b>:&nbsp;&nbsp;$nt[name] <br><b>E-mail</b>:&nbsp;&nbsp;$nt[email] <br><b>Estado</b>:$nt[estado] <br><a href='lista_detalles.php?post_id=$nt[post_id]&f_name=lista_no_aprovados.php'>Ver detalles</a></td><td align=right>".date("d-m-Y",strtotime($nt['fecha']))."</td></tr>";
